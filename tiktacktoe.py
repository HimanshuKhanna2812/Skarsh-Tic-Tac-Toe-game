...
root.title("Skarsh tic tac toe Game")
...
def score():
    if button1['text']=='X' and button2['text']=='X'and button3['text']=='X':
        ...
        score=n+1
        player1.set(score)
        tkinter.messagebox.showinfor("Congrats player 1 winner")
    ...
    if button1['text']=='O' and button2['text']=='O'and button3['text']=='O':
        ...
        score=n+1
        player2.set(score)
        tkinter.messagebox.showinfor("Congrats player 2 winner")
...
topf=Frame(root,width=1200,height=100,pady=2,bg="mistyrose",relief=RIDGE)
topf.grid(row=0,column=0)
topl=Label(topf,text="Skarsh Tic Tac Toe Game",bd=10,padx=84,pady=1,font="constantia 35 bold",bg="#1b7280",fg="white",justify=CENTER)
topl.grid(row=0,column=0)
mainf=Frame(root,bg="#298191",height=700,width=1100,relief=RIDGE)
mainf.grid(row=1,column=0)
f1=Frame(mainf,bg="#1b7280",height=550,width=650,relief=RIDGE,bd=8,pady=2,padx=10)
f1.pack(side=TOP)
f2=Frame(mainf,bg="#1b7280",height=600,width=500,relief=RIDGE,bd=7,pady=2,padx=10)
f2.pack(side=BOTTOM)
f21=Frame(f2,bg="#80601b",height=275,width=400,bd=4,pady=2,padx=10,relief=RIDGE)
f21.grid(row=0,column=0)
f22=Frame(f2,bg="#80601b",height=300,width=500,bd=4,pady=2,padx=10,relief=RIDGE)
